...
// saving user information in firestore database
...
const UserProvider = (props) => {
  ...
  // registering user through email and password.
  ...
  // product quantity managing
  
  const calQuantity = (item, event) => {
  ...
  // chacketot and setting cart empty.
  const checkOutOrder = () => {
    setCart([])
  }
